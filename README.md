...
To update the database use this command from the Web project folder (replace `HyundaiTracker` with your project's name):

```powershell
dotnet ef database update -c AppDbContext -p ../HyundaiTracker.Infrastructure/HyundaiTracker.Infrastructure.csproj -s HyundaiTracker.Web.csproj
```
